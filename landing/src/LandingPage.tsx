...
// NOTE: This is a copy of services/frontend/app/LandingPage.tsx, used for the
// standalone static marketing site (Cloudflare Pages). Keep visual changes in
// sync with the source. The only intentional difference: product links use the
// configurable LOGIN_URL below instead of a hardcoded "/login".
