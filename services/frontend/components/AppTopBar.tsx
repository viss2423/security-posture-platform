...
export default function AppTopBar() {
  ...
  return (
    <motion.header
      ...
      className="mb-4"
    >
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)]/88 p-4 shadow-xl shadow-black/20 backdrop-blur-xl sm:p-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="mb-2 flex flex-wrap items-center gap-2 text-xs text-[var(--muted)]">
              <span className="inline-flex items-center gap-1 rounded-full border border-[var(--border)] bg-[var(--surface-elevated)] px-2.5 py-1 font-semibold uppercase tracking-[0.12em]">
            ...
            <h2 className="[font-family:var(--font-display)] text-2xl font-semibold tracking-tight text-[var(--text)]">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="hidden rounded-xl border border-[var(--border)] bg-[var(--surface-elevated)] px-3 py-2 text-right sm:block">
              <p className="text-xs uppercase tracking-[0.12em] text-[var(--muted)]">{user?.role || 'viewer'}</p>
